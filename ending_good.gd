...
var story_data = [
	...
	{ "image": "res://image/エンディング(共通)/End3/END3_1.png", "texts": [
		"綾音「…… %d 点よ。」" % Global.score ,
		"綾音「よくやったわね、凄いわ。」 ",
		"桜「ふふん、当たり前でしょ？」",
		"明音「明音たち与座蔵町サイキョーのコンビだお？負けるわけないんだお！」",
		"綾音「コラコラ、天狗になりすぎないように。今後も修行を続けること、いいわね？」",
		"2人「うぃーっす。」",
		"綾音「……というわけで、あとで報酬の %d 円を口座に振り込むわね。大事に使うのよ。」" % Global.score ,
		"2人「いえーーーーい！！」",
		"明音「__ところで桜、そのお金何に使うつもりなんだお？」",
		"桜「そうねぇ、まあ半分くらいは生活に回すとして……」",
		"桜「……そうだ、いいこと思いついた！」"
	]},
	{ "image": "res://image/エンディング(共通)/End3/END3_2.png", "texts": [
		"ぽん助「__えぇ！？僕にくれるんですか！？」",
		"桜「うん、他の狸たちと大事に使ってね。」",
		"桜「昔私の面倒を見てくれたお礼よ。」",
		"ぽん助「うぅ、親分……嬉しいです！」",
		"明音「恩返しに使うなんて、桜優しいおね。」 ",
		"桜「だってここまでの大金、自分たちじゃ使い切れないし。」 ",
		"ぽん助「……そうだ、今度林の狸たちで宴をするんです。親分たちも来てくださいよ！」",
		"桜「えー！行く行くー！！」"
	]},
	{ "image": "res://image/エンディング(共通)/End3/END3_3.png", "texts": [
		" ……数日後、桜たちは雑木林で行われた、化け狸たちの宴に参加した。",
		"食事は全て木の実や昆虫だったが、音頭を踊り、囃子を奏で＿＿\n宴は大盛況で幕を閉じた。 ",
		"桜「やっぱこういうのは人のために使ってこそ、よね！」",
		"エンド3：真の億万長者 ",
		"<fade_out:0.8:black>", 
		"<wait:0.2>"
	]},
