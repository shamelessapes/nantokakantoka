...
var story_data = [
	...
	{ "image": "res://image/エンディング(共通)/End1/END1_1.png", "texts": [
		"綾音「……えーっと、 %d 点よ。」" % Global.score ,
		"綾音「正直に言うと、低すぎるわ。期待はずれもいいところね。」 ",
		"桜「えーー！私たち頑張ったのに！」",
		"明音「そうだおそうだお！……まあ確かに何回かミスった気がするけど。」 ",
		"綾音「いい？その少しのミスが、妖怪退治においては命取りなの。」",
		"綾音「というわけで、報酬は無しよ。もっと精進するように。」",
		"2人「えーーーーっ！！」",
		" ……そんなわけで、2人の今回のおつかいは失敗した。 \n明音はともかく、もともと懐の寂しい桜は今後も厳しい生活が続くことだろう＿＿。 "
	]},
	{ "image": "res://image/エンディング(共通)/End1/END1_2.png", "texts": [
		"桜「……今日も夜ご飯は雑草で凌ぐかぁ。」",
		"桜はひとり虚しく呟き、今日もそこら辺の草を毟って帰るのだった。",
		"エンド1：埼玉県民",
		"<fade_out:0.8:black>", 
		"<wait:0.2>"
	]},
